      ...
      <div className="flex flex-1 max-w-7xl mx-auto px-4 sm:px-6 py-8 sm:py-12 lg:py-16">
        ...
        <main className="flex-1 md:ml-0 lg:ml-6 space-y-6 w-full mt-16 md:mt-0">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-4 sm:gap-6">
            {[
              { label: "Mentors Connected", value: "3", color: "bg-blue-500" },
              { label: "Internships Applied", value: "5", color: "bg-green-500" },
              { label: "Events Attended", value: "2", color: "bg-purple-500" },
              { label: "Resources Viewed", value: "10", color: "bg-indigo-500" },
            ].map((stat, index) => (
              <div
                key={index}
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
            ...
            <div className="bg-white p-4 sm:p-6 rounded-xl shadow-lg">
              ...
              <ul className="space-y-2 sm:space-y-3">
                {[
                  "Applied to Software Internship at TechCorp - 2 days ago",
                  "Connected with Mentor Jane Doe - 4 days ago",
                  "Viewed 'Resume Building Tips' resource - 1 week ago",
                ].map((activity, index) => (
            ...
            <div className="bg-white p-4 sm:p-6 rounded-xl shadow-lg">
              ...
              <ul className="space-y-2 sm:space-y-3">
                {[
                  { name: "Career Fair 2025", date: "Mar 10, 2025" },
